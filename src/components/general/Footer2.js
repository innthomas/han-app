...
function Footer() {
    return (
        <div className="relative-bottom clear-both bottom-0 left-0 flex flex-col md:flex-row justify-evenly items-center h-16 bg-stone-200 text-black ">
            <div className="flex justify-between items-center gap-10 md:gap-2">
               <img className="px-2 cursor-pointer" src={twitterLogo} alt="twitter"/>
               <img className="px-2 cursor-pointer" src={youtubeLogo} alt="youtube"/>
               <img className="px-2 cursor-pointer" src={IGLogo} alt="IG"/>
               <img className="px-2 cursor-pointer" src={fbLogo} alt="fb"/>
            </div>
