    ...
    return (
        ...
        <div className="">
            <nav className="m-4 flex justify-between items-center h-16 bg-white text-black relative shadow-sm font-mono role='navigation' ">
                <div className="">
                <img src={ukLogo} alt="uk logo" className='cursor-pointer' /></div>
                <div className="flex items-center">
                    ...
                    <span className="md:block hidden mx-3 cursor-pointer" >Login</span>
                    
                    <img className="md:block hidden mx-3 cursor-pointer" src={youtubeLogo} alt="youtube logo"/>
                    <img className="md:block hidden mx-3 cursor-pointer" src={twitterLogo} alt="twitter logo"/>
                    <img className="md:block hidden mx-3 cursor-pointer" src={fbLogo} alt="facebook logo"/>
                    <img className="md:block hidden mx-3 cursor-pointer" src={IGLogo } alt="IG logo"/>
                </div>
        ...
        <nav className="flex justify-between items-center h-16 bg-white text-black relative shadow-sm font-mono role='navigation' md:visible invisible mx-5">
                ...
                <Link className="p-4" to='/donate'><button className="rounded-md p-2 bg-yellow-500 transition duration-300 ease-in-out flex items-center animate-bounce hover:bg-green-300 text-white"
                >Donate</button></Link>
